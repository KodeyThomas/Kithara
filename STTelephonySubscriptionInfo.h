...
@property (nonatomic,copy,readonly) NSString * identifier;                                                         //@synthesize identifier=_identifier - In the implementation block                                          //@synthesize SIMLabel=_SIMLabel - In the implementation block
@property (nonatomic,copy,readonly) NSString * shortSIMLabel;                                                      //@synthesize shortSIMLabel=_shortSIMLabel - In the implementation block
                                        //@synthesize SIMStatus=_SIMStatus - In the implementation block
